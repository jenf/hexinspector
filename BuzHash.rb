class BuzHash
  # Based on John Hamer's implementation
  # https://www.se.auckland.ac.nz/courses/SOFTENG250/archive/2006/assignments/Hashing/BuzHash.java
  @@buztbl = [ 0xC3113E7F,0x4C353C5F,0x7423810B,0x258D264E,0xDAD39DED,0x75D0B694,0x98CE1216,0x93334482,
...
#puts BuzHash.buzhash("\x22\x00\xaa\xff")

#c = BuzHash.combine(a,b)
#d = BuzHash.combine(a,c)
#e = BuzHash.combine(c,b)

a = 3818775938
#puts BuzHash.combine(0, a)
#puts b = BuzHash.combine(a, a)
#puts c = BuzHash.combine(a, b)
...
a1 = BuzHash.combine(a,b)
b1 = BuzHash.combine(b,c)
c1 = BuzHash.combine(c,d)

puts [a,b,c]
puts
puts [a1,b1,c1]

c2 = BuzHash.combine(a1,c)

j1 = BuzHash.combine(a,c2,2)
puts
puts [c2,j1]
#exit(1)
#puts a
#puts b
#puts f = BuzHash.combine(0,a)
#puts BuzHash.combine(a,f)
#puts g = BuzHash.combine(f,a)
#puts h = BuzHash.combine(a,g)
#puts i = BuzHash.combine(b,h)
h="1234 5678 9ABC FRED"
hashlen=5
puts BuzHash.combine(0,0)
hash=0 # 1783936964
#puts "%s %s %s %s %s" % [a,b,c,d,e]

i=BuzHash.buzhash("9ABC ",hash)

n=0
puts "Looking for %s" % i
h.each_byte {|x|
#  puts n>= hashlen 
  hash = BuzHash.rollhash(x,h[n-hashlen], n, hashlen, hash)
#  puts hash
